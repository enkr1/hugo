---
title: "My Workout Plan: Block 1 (Road to Stage)"
date: 2026-07-10T17:25:00+08:00
tags:
  - "fitness"
  - "workout"
  - "training-block"
...
subtitle: "the 12-week rebuild: same container, harder deadline"
...
| C2 | Machine Reverse Fly / Reverse Pec Deck / Face Pull (rear delts) | 3 x 12-20 | 5 |

---

## Day 4: Rest

recovery, joint freshness, performance reset — and posing practice, because that's a skill with a deadline too.
...
| C | Cable Archery Row / Face Pull (upper back, elbows flared) | 2 x 12-15 | 28 |
...
| C | Cable Dual Lateral Raise / DB Lateral Raise (side delts) | 2 x 15-25 | 5+ |
...
block 1 started **2026-07-04**. it's the first block of a longer runway — the goal at the end of it is a stage, not a mirror selfie. the retro's verdict was that the container works, so the container barely changed. what changed is how it's run:
...
- **day 4 is no longer just rest.** posing practice lives there now, because that's a skill with a deadline too.
- **the weak points found in the retro (delts, upper chest) get paid first.** they keep their first-slot, fresh-muscle placement — and they're the metric the next audit will be judged on.
- **stricter judging.** every session logged in the same system the last 12 weeks live in; progression is the default — when the top of a rep range is owned, weight moves; weekly check-in photos; and at deload, the block gets audited against the parts-split data.

the parts split taught me that a plan is a container, not a promise. this container just has a harder deadline.
